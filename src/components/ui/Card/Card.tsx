...
const bgTable: Record<'primary' | 'secondary', string> = {
    primary: 'bg-[--tg-theme-secondary-bg-color]',
    secondary: 'bg-[--tg-theme-section-bg-color]',
}
...
export const Card: FC<CardProps> = ({
    ...
    return (
        <Wrapper
            className={cn(`${bgTable[variant]} ${paddingTable[padding]} ${marginTable[margin]} rounded`, {}, [
                className,
            ])}
            {...otherProps}
        >
